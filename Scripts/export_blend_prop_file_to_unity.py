...
from blender_exporter.export_blend_file import apply_all_transforms, export_blend_3d_prop_file
...
def main(blend_file_path_str : str) -> None:
    ...
    export_blend_3d_prop_file(temp_file_path_str, blend_file_path_str)
