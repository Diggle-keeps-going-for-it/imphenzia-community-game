...
from blender_exporter.export_blend_file import apply_all_transforms, export_blend_3d_tile_file
...
def main(blend_file_path_str : str) -> None:
    ...
    export_blend_3d_tile_file(temp_file_path_str, blend_file_path_str)


if __name__ == '__main__':
    parser = ArgumentParser(description='Export a single \'.blend\' file\'s tile models from art source to Unity source.')
