...
{
    public static void Relax(Sylves.MeshData meshData, int iterations = 10, float forceApplicationPerIteration = 1e-3f)
    {
    ...
    )
    {
        ...
        output.p0 = averagedOffset               + center - p0;
        output.p1 = Rotate270_2d(averagedOffset) + center - p1;
        output.p2 = Rotate180_2d(averagedOffset) + center - p2;
        output.p3 = Rotate90_2d (averagedOffset) + center - p3;
